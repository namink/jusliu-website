...
<template>
  <section class="min-h-screen w-full flex items-center justify-center relative px-6 pb-16">
    <div
    ...
    >
      <p class="text-[11px] font-mono tracking-[0.3em] text-white/15 mb-6">{{ t('since') }}</p>
